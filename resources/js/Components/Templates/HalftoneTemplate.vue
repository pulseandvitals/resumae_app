...
<template>
    <div class="bg-white text-gray-900">
        <header
            class="relative overflow-hidden p-8"
            style="background-image: radial-gradient(circle, rgba(217,70,239,0.25) 1.5px, transparent 1.5px); background-size: 10px 10px;"
        >
            <div class="flex items-start gap-5">
                ...
                />
                <div class="relative inline-block rounded bg-white/90 p-3">
