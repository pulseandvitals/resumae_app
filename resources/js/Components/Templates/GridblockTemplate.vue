...
<template>
    <div class="bg-white p-10 text-gray-900">
        <header class="pb-4">
            ...
            <p v-if="resume.personal.title" class="mt-0.5 text-sm font-medium text-sky-600">
                {{ resume.personal.title }}
            </p>
            <div class="mt-3 grid grid-cols-2 gap-x-6 gap-y-1 border-t border-gray-200 pt-3 sm:grid-cols-4">
                <div v-if="resume.personal.email">
                    <p class="text-[10px] font-semibold uppercase tracking-wide text-gray-400">Email</p>
                    <p class="text-xs text-gray-700">{{ resume.personal.email }}</p>
                </div>
                <div v-if="resume.personal.phone">
                    <p class="text-[10px] font-semibold uppercase tracking-wide text-gray-400">Phone</p>
                    <p class="text-xs text-gray-700">{{ resume.personal.phone }}</p>
                </div>
                <div v-if="resume.personal.address">
                    <p class="text-[10px] font-semibold uppercase tracking-wide text-gray-400">Address</p>
                    <p class="text-xs text-gray-700">{{ resume.personal.address }}</p>
                </div>
                <div v-if="resume.personal.website">
                    <p class="text-[10px] font-semibold uppercase tracking-wide text-gray-400">Website</p>
                    <p class="text-xs text-gray-700">{{ resume.personal.website }}</p>
                </div>
                <div v-if="resume.personal.profileLink">
                    <p class="text-[10px] font-semibold uppercase tracking-wide text-gray-400">Profile</p>
                    <p class="text-xs text-gray-700">{{ resume.personal.profileLink }}</p>
                </div>
            </div>
        </header>

        <section v-if="resume.summary" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-sky-600">Summary</h2>
            <p class="mt-1.5 text-sm leading-relaxed text-gray-700">{{ resume.summary }}</p>
        </section>

        <section v-if="hasExperience" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-sky-600">Experience</h2>
        ...
        <section v-if="hasEducation" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-sky-600">Education</h2>
        ...
        <section v-if="resume.skills.length" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-sky-600">Skills</h2>
        ...
        <section v-if="hasProjects" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-sky-600">Projects</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasCertifications" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-sky-600">Certifications</h2>
        ...
        <section v-if="hasTrainings" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-sky-600">Trainings & Seminars</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasAwards" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-sky-600">Awards & Achievements</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasVolunteer" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-sky-600">Volunteer Experience</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasLanguages" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-sky-600">Languages</h2>
        ...
        <section v-for="section in visibleCustomSections" :key="section.id" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-sky-600">{{ section.title || 'Additional Information' }}</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasReferences" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-sky-600">References</h2>
            <div class="mt-2 space-y-1">
