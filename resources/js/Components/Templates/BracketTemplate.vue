...
<template>
    <div class="bg-white p-10 text-gray-900">
        <header class="flex items-start gap-5 border-b border-gray-200 pb-4">
            ...
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-gray-900">
                    <span class="text-teal-500">[</span> {{ resume.personal.fullName || 'Your Name' }} <span class="text-teal-500">]</span>
                </h1>
                <p v-if="resume.personal.title" class="mt-0.5 text-sm font-medium text-teal-600">
        ...
        <section v-if="resume.summary" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-teal-500">[</span> Summary <span class="text-teal-500">]</span></h2>
            <p class="mt-1.5 text-sm leading-relaxed text-gray-700">{{ resume.summary }}</p>
        </section>

        <section v-if="hasExperience" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-teal-500">[</span> Experience <span class="text-teal-500">]</span></h2>
        ...
        <section v-if="hasEducation" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-teal-500">[</span> Education <span class="text-teal-500">]</span></h2>
        ...
        <section v-if="resume.skills.length" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-teal-500">[</span> Skills <span class="text-teal-500">]</span></h2>
        ...
        <section v-if="hasProjects" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-teal-500">[</span> Projects <span class="text-teal-500">]</span></h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasCertifications" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-teal-500">[</span> Certifications <span class="text-teal-500">]</span></h2>
        ...
        <section v-if="hasTrainings" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-teal-500">[</span> Trainings & Seminars <span class="text-teal-500">]</span></h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasAwards" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-teal-500">[</span> Awards & Achievements <span class="text-teal-500">]</span></h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasVolunteer" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-teal-500">[</span> Volunteer Experience <span class="text-teal-500">]</span></h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasLanguages" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-teal-500">[</span> Languages <span class="text-teal-500">]</span></h2>
        ...
        <section v-for="section in visibleCustomSections" :key="section.id" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900">
                <span class="text-teal-500">[</span> {{ section.title || 'Additional Information' }} <span class="text-teal-500">]</span>
            </h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasReferences" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-teal-500">[</span> References <span class="text-teal-500">]</span></h2>
            <div class="mt-2 space-y-1">
