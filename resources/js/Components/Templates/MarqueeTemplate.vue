...
<template>
    <div class="bg-white p-10 text-gray-900">
        <header class="border-4 border-amber-500 p-6 text-center">
            <img
            ...
            />
            <h1 class="mt-2 text-2xl font-bold tracking-tight text-gray-900">{{ resume.personal.fullName || 'Your Name' }}</h1>
            <div class="mx-auto mt-2 flex justify-center gap-1">
                <span v-for="n in 5" :key="n" class="size-1.5 rounded-full bg-amber-500"></span>
            </div>
            <p v-if="resume.personal.title" class="mt-2 text-center text-sm font-medium text-amber-600">
                {{ resume.personal.title }}
            </p>
            <p v-if="contactLine.length" class="mt-2 text-center text-xs leading-relaxed text-gray-500">
                {{ contactLine.join(' · ') }}
            </p>
        </header>

        <section v-if="resume.summary" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-amber-600">Summary</h2>
            <p class="mt-1.5 text-sm leading-relaxed text-gray-700">{{ resume.summary }}</p>
        </section>

        <section v-if="hasExperience" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-amber-600">Experience</h2>
        ...
        <section v-if="hasEducation" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-amber-600">Education</h2>
        ...
        <section v-if="resume.skills.length" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-amber-600">Skills</h2>
        ...
        <section v-if="hasProjects" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-amber-600">Projects</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasCertifications" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-amber-600">Certifications</h2>
        ...
        <section v-if="hasTrainings" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-amber-600">Trainings & Seminars</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasAwards" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-amber-600">Awards & Achievements</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasVolunteer" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-amber-600">Volunteer Experience</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasLanguages" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-amber-600">Languages</h2>
        ...
        <section v-for="section in visibleCustomSections" :key="section.id" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-amber-600">{{ section.title || 'Additional Information' }}</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasReferences" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-amber-600">References</h2>
            <div class="mt-2 space-y-1">
