...
<template>
    <div class="bg-white p-10 text-gray-900">
        ...
        <section v-if="resume.summary" class="mt-5">
            <h2 class="inline-block rounded bg-orange-600 px-2.5 py-1 text-xs font-bold uppercase tracking-wide text-white">Summary</h2>
            <p class="mt-1.5 text-sm leading-relaxed text-gray-700">{{ resume.summary }}</p>
        </section>

        <section v-if="hasExperience" class="mt-5">
            <h2 class="inline-block rounded bg-orange-600 px-2.5 py-1 text-xs font-bold uppercase tracking-wide text-white">Experience</h2>
        ...
        <section v-if="hasEducation" class="mt-5">
            <h2 class="inline-block rounded bg-orange-600 px-2.5 py-1 text-xs font-bold uppercase tracking-wide text-white">Education</h2>
        ...
        <section v-if="resume.skills.length" class="mt-5">
            <h2 class="inline-block rounded bg-orange-600 px-2.5 py-1 text-xs font-bold uppercase tracking-wide text-white">Skills</h2>
        ...
        <section v-if="hasProjects" class="mt-5">
            <h2 class="inline-block rounded bg-orange-600 px-2.5 py-1 text-xs font-bold uppercase tracking-wide text-white">Projects</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasCertifications" class="mt-5">
            <h2 class="inline-block rounded bg-orange-600 px-2.5 py-1 text-xs font-bold uppercase tracking-wide text-white">Certifications</h2>
        ...
        <section v-if="hasTrainings" class="mt-5">
            <h2 class="inline-block rounded bg-orange-600 px-2.5 py-1 text-xs font-bold uppercase tracking-wide text-white">Trainings & Seminars</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasAwards" class="mt-5">
            <h2 class="inline-block rounded bg-orange-600 px-2.5 py-1 text-xs font-bold uppercase tracking-wide text-white">Awards & Achievements</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasVolunteer" class="mt-5">
            <h2 class="inline-block rounded bg-orange-600 px-2.5 py-1 text-xs font-bold uppercase tracking-wide text-white">Volunteer Experience</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasLanguages" class="mt-5">
            <h2 class="inline-block rounded bg-orange-600 px-2.5 py-1 text-xs font-bold uppercase tracking-wide text-white">Languages</h2>
        ...
        <section v-for="section in visibleCustomSections" :key="section.id" class="mt-5">
            <h2 class="inline-block rounded bg-orange-600 px-2.5 py-1 text-xs font-bold uppercase tracking-wide text-white">{{ section.title || 'Additional Information' }}</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasReferences" class="mt-5">
            <h2 class="inline-block rounded bg-orange-600 px-2.5 py-1 text-xs font-bold uppercase tracking-wide text-white">References</h2>
            <div class="mt-2 space-y-1">
