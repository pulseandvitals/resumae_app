...
<template>
    <div class="bg-white p-10 text-gray-900">
        <header class="border-b border-gray-200 pb-4">
            <h1 class="inline-block border-b-4 border-amber-500 pb-1 text-2xl font-bold tracking-tight">{{ resume.personal.fullName || 'Your Name' }}</h1>
            <p v-if="resume.personal.title" class="mt-1 text-sm font-medium text-amber-600">
        ...
        <section v-if="resume.summary" class="mt-5">
            <h2 class="flex items-baseline gap-2 text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-amber-500">01</span>Summary</h2>
            <p class="mt-1.5 text-sm leading-relaxed text-gray-700">{{ resume.summary }}</p>
        </section>

        <section v-if="hasExperience" class="mt-5">
            <h2 class="flex items-baseline gap-2 text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-amber-500">02</span>Experience</h2>
        ...
        <section v-if="hasEducation" class="mt-5">
            <h2 class="flex items-baseline gap-2 text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-amber-500">03</span>Education</h2>
        ...
        <section v-if="resume.skills.length" class="mt-5">
            <h2 class="flex items-baseline gap-2 text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-amber-500">04</span>Skills</h2>
        ...
        <section v-if="hasProjects" class="mt-5">
            <h2 class="flex items-baseline gap-2 text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-amber-500">05</span>Projects</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasCertifications" class="mt-5">
            <h2 class="flex items-baseline gap-2 text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-amber-500">06</span>Certifications</h2>
        ...
        <section v-if="hasTrainings" class="mt-5">
            <h2 class="flex items-baseline gap-2 text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-amber-500">07</span>Trainings & Seminars</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasAwards" class="mt-5">
            <h2 class="flex items-baseline gap-2 text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-amber-500">08</span>Awards & Achievements</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasVolunteer" class="mt-5">
            <h2 class="flex items-baseline gap-2 text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-amber-500">09</span>Volunteer Experience</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasLanguages" class="mt-5">
            <h2 class="flex items-baseline gap-2 text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-amber-500">10</span>Languages</h2>
        ...
        <section v-for="section in visibleCustomSections" :key="section.id" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900">{{ section.title || 'Additional Information' }}</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasReferences" class="mt-5">
            <h2 class="flex items-baseline gap-2 text-xs font-bold uppercase tracking-wide text-gray-900"><span class="text-amber-500">11</span>References</h2>
            <div class="mt-2 space-y-1">
