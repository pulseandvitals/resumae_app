...
const skillColors = ['bg-teal-100 text-teal-700', 'bg-purple-100 text-purple-700', 'bg-pink-100 text-pink-700'];
</script>

<template>
    <div class="bg-white text-gray-900">
        <header class="flex items-center gap-5 rounded-b-2xl bg-gradient-to-r from-teal-500 to-purple-500 p-8 text-white">
            <img
                v-if="resume.personal.photo"
                :src="resume.personal.photo"
                alt="Profile photo"
                class="size-20 shrink-0 rounded-2xl object-cover ring-4 ring-white/30"
            />
            <div>
                <h1 class="text-2xl font-extrabold tracking-tight">{{ resume.personal.fullName || 'Your Name' }}</h1>
                <p v-if="resume.personal.title" class="mt-1 text-sm font-semibold text-white/90">
                    {{ resume.personal.title }}
                </p>
                <p v-if="contactLine.length" class="mt-2 text-xs leading-relaxed text-white/80">
                    {{ contactLine.join(' · ') }}
                </p>
            </div>
        </header>
        ...
        <div class="p-10">
            <section v-if="resume.summary">
                <h2 class="text-xs font-extrabold uppercase tracking-wide text-teal-600">Summary</h2>
                <p class="mt-1.5 text-sm leading-relaxed text-gray-700">{{ resume.summary }}</p>
            </section>

            <section v-if="resume.skills.length" class="mt-6">
                <h2 class="text-xs font-extrabold uppercase tracking-wide text-purple-600">Skills</h2>
            ...
            <section v-if="hasExperience" class="mt-6">
                <h2 class="text-xs font-extrabold uppercase tracking-wide text-teal-600">Experience</h2>
                <div class="mt-2 space-y-3">
                    <div v-for="entry in resume.experience" :key="entry.id">
                        ...
                        <p v-if="entry.achievements" class="mt-1 whitespace-pre-line text-sm leading-relaxed text-gray-700">
                            <span class="font-medium text-purple-600">Achievements: </span>{{ entry.achievements }}
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section v-if="hasEducation" class="mt-6">
                <h2 class="text-xs font-extrabold uppercase tracking-wide text-teal-600">Education</h2>
            ...
            <section v-if="hasProjects" class="mt-6">
                <h2 class="text-xs font-extrabold uppercase tracking-wide text-purple-600">Projects</h2>
                <div class="mt-2 space-y-2">
            ...
            <section v-if="hasCertifications" class="mt-6">
                <h2 class="text-xs font-extrabold uppercase tracking-wide text-teal-600">Certifications</h2>
            ...
            <section v-if="hasTrainings" class="mt-6">
                <h2 class="text-xs font-extrabold uppercase tracking-wide text-purple-600">Trainings & Seminars</h2>
                <div class="mt-2 space-y-2">
            ...
            <section v-if="hasAwards" class="mt-6">
                <h2 class="text-xs font-extrabold uppercase tracking-wide text-teal-600">Awards & Achievements</h2>
                <div class="mt-2 space-y-2">
            ...
            <section v-if="hasVolunteer" class="mt-6">
                <h2 class="text-xs font-extrabold uppercase tracking-wide text-purple-600">Volunteer Experience</h2>
                <div class="mt-2 space-y-2">
            ...
            <section v-if="hasLanguages" class="mt-6">
                <h2 class="text-xs font-extrabold uppercase tracking-wide text-teal-600">Languages</h2>
            ...
            <section v-for="section in visibleCustomSections" :key="section.id" class="mt-6">
                <h2 class="text-xs font-extrabold uppercase tracking-wide text-purple-600">{{ section.title || 'Additional Information' }}</h2>
                <div class="mt-2 space-y-2">
            ...
            <section v-if="hasReferences" class="mt-6">
                <h2 class="text-xs font-extrabold uppercase tracking-wide text-teal-600">References</h2>
                <div class="mt-2 space-y-1">
