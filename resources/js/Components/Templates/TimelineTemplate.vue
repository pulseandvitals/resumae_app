    ...
    <div class="bg-white p-10 text-gray-900">
        <header class="flex items-start gap-5 border-b border-gray-200 pb-4">
            ...
            <div>
                ...
                <p v-if="resume.personal.title" class="mt-0.5 text-sm font-medium text-blue-600">
        ...
        <section v-if="hasExperience" class="mt-5">
            ...
            <div class="relative mt-3 space-y-4 border-l-2 border-blue-200 pl-6">
                <div v-for="entry in resume.experience" :key="entry.id" class="relative">
                    <span v-if="entry.position || entry.company" class="absolute -left-[27px] top-1 size-2.5 rounded-full bg-blue-500"></span>
        ...
        <section v-if="hasEducation" class="mt-5">
            ...
            <div class="relative mt-3 space-y-3 border-l-2 border-blue-200 pl-6">
                <div v-for="entry in resume.education" :key="entry.id" class="relative">
                    <span v-if="entry.school || entry.degree" class="absolute -left-[27px] top-1 size-2.5 rounded-full bg-blue-500"></span>
