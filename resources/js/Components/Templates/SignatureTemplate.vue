...
<template>
    <div class="bg-white p-10 text-gray-900">
        <header class="border-b border-gray-200 pb-4 text-center">
            ...
            />
            <h1 class="mt-2 text-center font-serif text-3xl italic tracking-tight text-gray-900">{{ resume.personal.fullName || 'Your Name' }}</h1>
            <div class="mx-auto mt-1 h-px w-24 bg-rose-400"></div>
            <p v-if="resume.personal.title" class="mt-2 text-center text-sm font-medium text-rose-600">
        ...
        <section v-if="resume.summary" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-gray-500">Summary</h2>
            <p class="mt-1.5 text-sm leading-relaxed text-gray-700">{{ resume.summary }}</p>
        </section>

        <section v-if="hasExperience" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-gray-500">Experience</h2>
        ...
        <section v-if="hasEducation" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-gray-500">Education</h2>
        ...
        <section v-if="resume.skills.length" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-gray-500">Skills</h2>
        ...
        <section v-if="hasProjects" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-gray-500">Projects</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasCertifications" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-gray-500">Certifications</h2>
        ...
        <section v-if="hasTrainings" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-gray-500">Trainings & Seminars</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasAwards" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-gray-500">Awards & Achievements</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasVolunteer" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-gray-500">Volunteer Experience</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasLanguages" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-gray-500">Languages</h2>
        ...
        <section v-for="section in visibleCustomSections" :key="section.id" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-gray-500">{{ section.title || 'Additional Information' }}</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasReferences" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-widest text-gray-500">References</h2>
            <div class="mt-2 space-y-1">
