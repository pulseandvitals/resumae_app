...
<template>
    <div class="bg-white p-10 text-gray-900">
        <header class="flex items-start gap-5 border-b border-gray-200 pb-4">
            ...
            />
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-pink-600">{{ resume.personal.fullName || 'Your Name' }}</h1>
                <p v-if="resume.personal.title" class="mt-0.5 text-sm font-medium text-pink-600">
        ...
        <section v-if="resume.summary" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-pink-600">Summary</h2>
            <p class="mt-1.5 text-sm leading-relaxed text-gray-700">{{ resume.summary }}</p>
        </section>

        <section v-if="hasExperience" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-pink-600">Experience</h2>
        ...
        <section v-if="hasEducation" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-pink-600">Education</h2>
        ...
        <section v-if="resume.skills.length" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-pink-600">Skills</h2>
            <div class="mt-2 flex flex-wrap gap-1.5">
                <span
                    v-for="(skill, index) in resume.skills"
                    :key="skill"
                    :class="['bg-pink-500', 'bg-violet-500', 'bg-amber-500', 'bg-emerald-500'][index % 4]"
                    class="flex h-10 items-center justify-center rounded px-2 text-center text-[11px] font-semibold text-white"
                >
                    {{ skill }}
                </span>
            </div>
        ...
        <section v-if="hasProjects" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-pink-600">Projects</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasCertifications" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-pink-600">Certifications</h2>
        ...
        <section v-if="hasTrainings" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-pink-600">Trainings & Seminars</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasAwards" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-pink-600">Awards & Achievements</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasVolunteer" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-pink-600">Volunteer Experience</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasLanguages" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-pink-600">Languages</h2>
        ...
        <section v-for="section in visibleCustomSections" :key="section.id" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-pink-600">{{ section.title || 'Additional Information' }}</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasReferences" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-pink-600">References</h2>
            <div class="mt-2 space-y-1">
