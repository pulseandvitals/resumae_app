...
<template>
    <div class="bg-white p-10 text-gray-900">
        <header class="flex items-start justify-between gap-6 pb-4">
            ...
            <div v-if="contactLine.length" class="shrink-0 text-right">
                <p v-for="item in contactLine" :key="item" class="text-xs leading-relaxed text-gray-500">{{ item }}</p>
            </div>
        </header>

        <div class="mt-4 h-1 w-full" :class="theme.bg"></div>
