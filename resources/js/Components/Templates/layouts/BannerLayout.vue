...
<template>
    <div class="bg-white text-gray-900">
        <header class="flex items-center gap-5 p-8" :class="theme.bg">
            <img
            ...
            />
            <div>
                <h1 class="text-2xl font-bold tracking-tight" :class="theme.textOnBg">{{ resume.personal.fullName || 'Your Name' }}</h1>
                <p v-if="resume.personal.title" class="mt-0.5 text-sm font-medium" :class="[theme.textOnBg, 'opacity-90']">
                    {{ resume.personal.title }}
                </p>
                <p v-if="contactLine.length" class="mt-2 text-xs leading-relaxed" :class="[theme.textOnBg, 'opacity-80']">
                    {{ contactLine.join(' · ') }}
                </p>
            </div>
        </header>
