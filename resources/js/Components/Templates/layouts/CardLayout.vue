...
<template>
    <div class="bg-white p-10 text-gray-900">
        ...
        <section v-if="resume.summary" class="mt-4 rounded-lg border border-gray-200 p-4 shadow-sm">
            <div class="-mx-4 -mt-4 mb-3 h-1 rounded-t-lg" :class="theme.bg"></div>
            <h2 class="text-xs font-bold uppercase tracking-wide" :class="theme.text">Summary</h2>
            <p class="mt-1.5 text-sm leading-relaxed text-gray-700">{{ resume.summary }}</p>
        </section>

        <section v-if="hasExperience" class="mt-4 rounded-lg border border-gray-200 p-4 shadow-sm">
            <div class="-mx-4 -mt-4 mb-3 h-1 rounded-t-lg" :class="theme.bg"></div>
            <h2 class="text-xs font-bold uppercase tracking-wide" :class="theme.text">Experience</h2>
        ...
        <section v-if="hasEducation" class="mt-4 rounded-lg border border-gray-200 p-4 shadow-sm">
            <div class="-mx-4 -mt-4 mb-3 h-1 rounded-t-lg" :class="theme.bg"></div>
            <h2 class="text-xs font-bold uppercase tracking-wide" :class="theme.text">Education</h2>
        ...
        <section v-if="resume.skills.length" class="mt-4 rounded-lg border border-gray-200 p-4 shadow-sm">
            <div class="-mx-4 -mt-4 mb-3 h-1 rounded-t-lg" :class="theme.bg"></div>
            <h2 class="text-xs font-bold uppercase tracking-wide" :class="theme.text">Skills</h2>
            <div class="mt-2 flex flex-wrap gap-1.5">
                <span v-for="skill in resume.skills" :key="skill" class="rounded-full px-2.5 py-0.5 text-xs font-medium" :class="[theme.chipBg, theme.chipText]">
                    {{ skill }}
                </span>
            </div>
        </section>

        <section v-if="hasProjects" class="mt-4 rounded-lg border border-gray-200 p-4 shadow-sm">
            <div class="-mx-4 -mt-4 mb-3 h-1 rounded-t-lg" :class="theme.bg"></div>
            <h2 class="text-xs font-bold uppercase tracking-wide" :class="theme.text">Projects</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasCertifications" class="mt-4 rounded-lg border border-gray-200 p-4 shadow-sm">
            <div class="-mx-4 -mt-4 mb-3 h-1 rounded-t-lg" :class="theme.bg"></div>
            <h2 class="text-xs font-bold uppercase tracking-wide" :class="theme.text">Certifications</h2>
        ...
        <section v-if="hasTrainings" class="mt-4 rounded-lg border border-gray-200 p-4 shadow-sm">
            <div class="-mx-4 -mt-4 mb-3 h-1 rounded-t-lg" :class="theme.bg"></div>
            <h2 class="text-xs font-bold uppercase tracking-wide" :class="theme.text">Trainings & Seminars</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasAwards" class="mt-4 rounded-lg border border-gray-200 p-4 shadow-sm">
            <div class="-mx-4 -mt-4 mb-3 h-1 rounded-t-lg" :class="theme.bg"></div>
            <h2 class="text-xs font-bold uppercase tracking-wide" :class="theme.text">Awards & Achievements</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasVolunteer" class="mt-4 rounded-lg border border-gray-200 p-4 shadow-sm">
            <div class="-mx-4 -mt-4 mb-3 h-1 rounded-t-lg" :class="theme.bg"></div>
            <h2 class="text-xs font-bold uppercase tracking-wide" :class="theme.text">Volunteer Experience</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasLanguages" class="mt-4 rounded-lg border border-gray-200 p-4 shadow-sm">
            <div class="-mx-4 -mt-4 mb-3 h-1 rounded-t-lg" :class="theme.bg"></div>
            <h2 class="text-xs font-bold uppercase tracking-wide" :class="theme.text">Languages</h2>
        ...
        <section v-for="section in visibleCustomSections" :key="section.id" class="mt-4 rounded-lg border border-gray-200 p-4 shadow-sm">
            <div class="-mx-4 -mt-4 mb-3 h-1 rounded-t-lg" :class="theme.bg"></div>
            <h2 class="text-xs font-bold uppercase tracking-wide" :class="theme.text">{{ section.title || 'Additional Information' }}</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasReferences" class="mt-4 rounded-lg border border-gray-200 p-4 shadow-sm">
            <div class="-mx-4 -mt-4 mb-3 h-1 rounded-t-lg" :class="theme.bg"></div>
            <h2 class="text-xs font-bold uppercase tracking-wide" :class="theme.text">References</h2>
            <div class="mt-2 space-y-1">
