...
<template>
    <div class="bg-white p-10 text-gray-900">
        ...
        <section v-if="resume.summary" class="mt-4 border-l-4 py-1 pl-4" :class="theme.border">
        ...
        <section v-if="hasExperience" class="mt-4 border-l-4 py-1 pl-4" :class="theme.border">
        ...
        <section v-if="hasEducation" class="mt-4 border-l-4 py-1 pl-4" :class="theme.border">
        ...
        <section v-if="resume.skills.length" class="mt-4 border-l-4 py-1 pl-4" :class="theme.border">
        ...
        <section v-if="hasProjects" class="mt-4 border-l-4 py-1 pl-4" :class="theme.border">
        ...
        <section v-if="hasCertifications" class="mt-4 border-l-4 py-1 pl-4" :class="theme.border">
        ...
        <section v-if="hasTrainings" class="mt-4 border-l-4 py-1 pl-4" :class="theme.border">
        ...
        <section v-if="hasAwards" class="mt-4 border-l-4 py-1 pl-4" :class="theme.border">
        ...
        <section v-if="hasVolunteer" class="mt-4 border-l-4 py-1 pl-4" :class="theme.border">
        ...
        <section v-if="hasLanguages" class="mt-4 border-l-4 py-1 pl-4" :class="theme.border">
        ...
        <section v-for="section in visibleCustomSections" :key="section.id" class="mt-4 border-l-4 py-1 pl-4" :class="theme.border">
        ...
        <section v-if="hasReferences" class="mt-4 border-l-4 py-1 pl-4" :class="theme.border">
