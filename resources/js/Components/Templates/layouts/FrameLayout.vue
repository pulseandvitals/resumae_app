...
<template>
    <div class="border-4 p-1" :class="theme.border">
        <div class="border border-gray-200 p-8 font-serif text-gray-900">
            <header class="border-b border-gray-200 pb-4 text-center">
                <img
                ...
                />
                <h1 class="mt-2 text-2xl font-bold tracking-tight">{{ resume.personal.fullName || 'Your Name' }}</h1>
                <p v-if="resume.personal.title" class="mt-0.5 text-sm font-medium italic" :class="theme.text">
            ...
            <section v-if="resume.summary" class="mt-5">
                <h2 class="text-xs font-bold uppercase tracking-widest text-gray-500 border-t pt-2" :class="theme.border">Summary</h2>
                <p class="mt-1.5 text-sm leading-relaxed text-gray-700">{{ resume.summary }}</p>
            </section>

            <section v-if="hasExperience" class="mt-5">
                <h2 class="text-xs font-bold uppercase tracking-widest text-gray-500 border-t pt-2" :class="theme.border">Experience</h2>
            ...
            <section v-if="hasEducation" class="mt-5">
                <h2 class="text-xs font-bold uppercase tracking-widest text-gray-500 border-t pt-2" :class="theme.border">Education</h2>
            ...
            <section v-if="resume.skills.length" class="mt-5">
                <h2 class="text-xs font-bold uppercase tracking-widest text-gray-500 border-t pt-2" :class="theme.border">Skills</h2>
            ...
            <section v-if="hasProjects" class="mt-5">
                <h2 class="text-xs font-bold uppercase tracking-widest text-gray-500 border-t pt-2" :class="theme.border">Projects</h2>
                <div class="mt-2 space-y-2">
            ...
            <section v-if="hasCertifications" class="mt-5">
                <h2 class="text-xs font-bold uppercase tracking-widest text-gray-500 border-t pt-2" :class="theme.border">Certifications</h2>
            ...
            <section v-if="hasTrainings" class="mt-5">
                <h2 class="text-xs font-bold uppercase tracking-widest text-gray-500 border-t pt-2" :class="theme.border">Trainings & Seminars</h2>
                <div class="mt-2 space-y-2">
            ...
            <section v-if="hasAwards" class="mt-5">
                <h2 class="text-xs font-bold uppercase tracking-widest text-gray-500 border-t pt-2" :class="theme.border">Awards & Achievements</h2>
                <div class="mt-2 space-y-2">
            ...
            <section v-if="hasVolunteer" class="mt-5">
                <h2 class="text-xs font-bold uppercase tracking-widest text-gray-500 border-t pt-2" :class="theme.border">Volunteer Experience</h2>
                <div class="mt-2 space-y-2">
            ...
            <section v-if="hasLanguages" class="mt-5">
                <h2 class="text-xs font-bold uppercase tracking-widest text-gray-500 border-t pt-2" :class="theme.border">Languages</h2>
            ...
            <section v-for="section in visibleCustomSections" :key="section.id" class="mt-5">
                <h2 class="text-xs font-bold uppercase tracking-widest text-gray-500 border-t pt-2" :class="theme.border">{{ section.title || 'Additional Information' }}</h2>
                <div class="mt-2 space-y-2">
            ...
            <section v-if="hasReferences" class="mt-5">
                <h2 class="text-xs font-bold uppercase tracking-widest text-gray-500 border-t pt-2" :class="theme.border">References</h2>
                <div class="mt-2 space-y-1">
