...
<template>
    <div class="bg-white p-10 text-gray-900">
        <header class="flex flex-col items-center text-center">
            ...
            />
            <span class="mt-3 inline-block rounded-full px-4 py-1 text-xl font-bold" :class="[theme.bg, theme.textOnBg]">{{ resume.personal.fullName || 'Your Name' }}</span>
            <p v-if="resume.personal.title" class="mt-2 text-sm font-medium" :class="theme.text">
        ...
        <section v-if="resume.skills.length" class="mt-5">
            ...
            <div class="mt-2 flex flex-wrap gap-1.5">
                <span v-for="skill in resume.skills" :key="skill" class="rounded-full px-3 py-1 text-xs font-semibold" :class="[theme.bg, theme.textOnBg]">
                    {{ skill }}
                </span>
            </div>
        </section>
