...
<template>
    <div class="bg-white p-10 text-gray-900">
        ...
        <section v-if="resume.summary" class="mt-5">
            <h2 class="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide" :class="theme.text">
                <span class="inline-block size-1.5 rounded-full" :class="theme.bg"></span>Summary
            </h2>
        ...
        <section v-if="hasExperience" class="mt-5">
            <h2 class="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide" :class="theme.text">
                <span class="inline-block size-1.5 rounded-full" :class="theme.bg"></span>Experience
            </h2>
        ...
        <section v-if="hasEducation" class="mt-5">
            <h2 class="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide" :class="theme.text">
                <span class="inline-block size-1.5 rounded-full" :class="theme.bg"></span>Education
            </h2>
        ...
        <section v-if="resume.skills.length" class="mt-5">
            <h2 class="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide" :class="theme.text">
                <span class="inline-block size-1.5 rounded-full" :class="theme.bg"></span>Skills
            </h2>
        ...
        <section v-if="hasProjects" class="mt-5">
            <h2 class="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide" :class="theme.text">
                <span class="inline-block size-1.5 rounded-full" :class="theme.bg"></span>Projects
            </h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasCertifications" class="mt-5">
            <h2 class="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide" :class="theme.text">
                <span class="inline-block size-1.5 rounded-full" :class="theme.bg"></span>Certifications
            </h2>
        ...
        <section v-if="hasTrainings" class="mt-5">
            <h2 class="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide" :class="theme.text">
                <span class="inline-block size-1.5 rounded-full" :class="theme.bg"></span>Trainings & Seminars
            </h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasAwards" class="mt-5">
            <h2 class="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide" :class="theme.text">
                <span class="inline-block size-1.5 rounded-full" :class="theme.bg"></span>Awards & Achievements
            </h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasVolunteer" class="mt-5">
            <h2 class="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide" :class="theme.text">
                <span class="inline-block size-1.5 rounded-full" :class="theme.bg"></span>Volunteer Experience
            </h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasLanguages" class="mt-5">
            <h2 class="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide" :class="theme.text">
                <span class="inline-block size-1.5 rounded-full" :class="theme.bg"></span>Languages
            </h2>
        ...
        <section v-for="section in visibleCustomSections" :key="section.id" class="mt-5">
            <h2 class="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide" :class="theme.text">
                <span class="inline-block size-1.5 rounded-full" :class="theme.bg"></span>{{ section.title || 'Additional Information' }}
            </h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasReferences" class="mt-5">
            <h2 class="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide" :class="theme.text">
                <span class="inline-block size-1.5 rounded-full" :class="theme.bg"></span>References
            </h2>
            <div class="mt-2 space-y-1">
