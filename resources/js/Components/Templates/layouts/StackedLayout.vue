...
<template>
    <div class="bg-white p-10 text-gray-900">
        <header class="text-center">
            ...
            <p v-if="resume.personal.title" class="mt-0.5 text-sm font-medium" :class="theme.text">
                {{ resume.personal.title }}
            </p>
            <div v-if="contactLine.length" class="mt-2 flex flex-wrap justify-center gap-2">
                <span v-for="item in contactLine" :key="item" class="rounded-full border px-2.5 py-0.5 text-xs" :class="[theme.border, theme.text]">{{ item }}</span>
            </div>
        </header>

        <section v-if="resume.summary" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-wide text-gray-500">Summary</h2>
            <span class="mx-auto mt-1 block h-0.5 w-8" :class="theme.bg"></span>
            <p class="mt-1.5 text-sm leading-relaxed text-gray-700">{{ resume.summary }}</p>
        </section>

        <section v-if="hasExperience" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-wide text-gray-500">Experience</h2>
            <span class="mx-auto mt-1 block h-0.5 w-8" :class="theme.bg"></span>
        ...
        <section v-if="hasEducation" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-wide text-gray-500">Education</h2>
            <span class="mx-auto mt-1 block h-0.5 w-8" :class="theme.bg"></span>
        ...
        <section v-if="resume.skills.length" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-wide text-gray-500">Skills</h2>
            <span class="mx-auto mt-1 block h-0.5 w-8" :class="theme.bg"></span>
        ...
        <section v-if="hasProjects" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-wide text-gray-500">Projects</h2>
            <span class="mx-auto mt-1 block h-0.5 w-8" :class="theme.bg"></span>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasCertifications" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-wide text-gray-500">Certifications</h2>
            <span class="mx-auto mt-1 block h-0.5 w-8" :class="theme.bg"></span>
        ...
        <section v-if="hasTrainings" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-wide text-gray-500">Trainings & Seminars</h2>
            <span class="mx-auto mt-1 block h-0.5 w-8" :class="theme.bg"></span>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasAwards" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-wide text-gray-500">Awards & Achievements</h2>
            <span class="mx-auto mt-1 block h-0.5 w-8" :class="theme.bg"></span>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasVolunteer" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-wide text-gray-500">Volunteer Experience</h2>
            <span class="mx-auto mt-1 block h-0.5 w-8" :class="theme.bg"></span>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasLanguages" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-wide text-gray-500">Languages</h2>
            <span class="mx-auto mt-1 block h-0.5 w-8" :class="theme.bg"></span>
        ...
        <section v-for="section in visibleCustomSections" :key="section.id" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-wide text-gray-500">{{ section.title || 'Additional Information' }}</h2>
            <span class="mx-auto mt-1 block h-0.5 w-8" :class="theme.bg"></span>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasReferences" class="mt-5">
            <h2 class="text-center text-xs font-bold uppercase tracking-wide text-gray-500">References</h2>
            <span class="mx-auto mt-1 block h-0.5 w-8" :class="theme.bg"></span>
            <div class="mt-2 space-y-1">
