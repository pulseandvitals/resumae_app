...
<template>
    <div class="bg-white p-10 text-gray-900">
        <header class="flex items-start gap-5 border-4 border-gray-900 p-4">
            <img
            ...
            <div>
                ...
                <p v-if="resume.personal.title" class="mt-0.5 text-sm font-medium text-red-600">
        ...
        <section v-if="resume.summary" class="mt-4 border-4 border-gray-900 p-4">
            <h2 class="inline-block bg-gray-900 px-2 py-0.5 text-xs font-bold uppercase tracking-wide text-white">Summary</h2>
            <p class="mt-1.5 text-sm leading-relaxed text-gray-700">{{ resume.summary }}</p>
        </section>

        <section v-if="hasExperience" class="mt-4 border-4 border-gray-900 p-4">
            <h2 class="inline-block bg-gray-900 px-2 py-0.5 text-xs font-bold uppercase tracking-wide text-white">Experience</h2>
        ...
        <section v-if="hasEducation" class="mt-4 border-4 border-gray-900 p-4">
            <h2 class="inline-block bg-gray-900 px-2 py-0.5 text-xs font-bold uppercase tracking-wide text-white">Education</h2>
        ...
        <section v-if="resume.skills.length" class="mt-4 border-4 border-gray-900 p-4">
            <h2 class="inline-block bg-gray-900 px-2 py-0.5 text-xs font-bold uppercase tracking-wide text-white">Skills</h2>
        ...
        <section v-if="hasProjects" class="mt-4 border-4 border-gray-900 p-4">
            <h2 class="inline-block bg-gray-900 px-2 py-0.5 text-xs font-bold uppercase tracking-wide text-white">Projects</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasCertifications" class="mt-4 border-4 border-gray-900 p-4">
            <h2 class="inline-block bg-gray-900 px-2 py-0.5 text-xs font-bold uppercase tracking-wide text-white">Certifications</h2>
        ...
        <section v-if="hasTrainings" class="mt-4 border-4 border-gray-900 p-4">
            <h2 class="inline-block bg-gray-900 px-2 py-0.5 text-xs font-bold uppercase tracking-wide text-white">Trainings & Seminars</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasAwards" class="mt-4 border-4 border-gray-900 p-4">
            <h2 class="inline-block bg-gray-900 px-2 py-0.5 text-xs font-bold uppercase tracking-wide text-white">Awards & Achievements</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasVolunteer" class="mt-4 border-4 border-gray-900 p-4">
            <h2 class="inline-block bg-gray-900 px-2 py-0.5 text-xs font-bold uppercase tracking-wide text-white">Volunteer Experience</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasLanguages" class="mt-4 border-4 border-gray-900 p-4">
            <h2 class="inline-block bg-gray-900 px-2 py-0.5 text-xs font-bold uppercase tracking-wide text-white">Languages</h2>
        ...
        <section v-for="section in visibleCustomSections" :key="section.id" class="mt-4 border-4 border-gray-900 p-4">
            <h2 class="inline-block bg-gray-900 px-2 py-0.5 text-xs font-bold uppercase tracking-wide text-white">{{ section.title || 'Additional Information' }}</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasReferences" class="mt-4 border-4 border-gray-900 p-4">
            <h2 class="inline-block bg-gray-900 px-2 py-0.5 text-xs font-bold uppercase tracking-wide text-white">References</h2>
            <div class="mt-2 space-y-1">
