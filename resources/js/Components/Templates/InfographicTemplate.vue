...
<template>
    <div class="bg-white p-10 text-gray-900">
        <header class="flex items-start gap-5 border-b-2 border-orange-500 pb-4">
            <img
                v-if="resume.personal.photo"
                :src="resume.personal.photo"
                alt="Profile photo"
                class="size-16 shrink-0 rounded-full object-cover ring-2 ring-orange-200"
            />
            <div>
                <h1 class="text-2xl font-bold tracking-tight">{{ resume.personal.fullName || 'Your Name' }}</h1>
                <p v-if="resume.personal.title" class="mt-0.5 text-sm font-medium text-orange-600">
        ...
        <section v-if="resume.summary" class="mt-6">
            <h2 class="flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-gray-700">
                <span class="flex size-6 shrink-0 items-center justify-center rounded-full bg-orange-50 text-xs font-bold text-orange-600">1</span>
                Summary
            </h2>
            <p class="mt-2 pl-8 text-sm leading-relaxed text-gray-700">{{ resume.summary }}</p>
        </section>

        <section v-if="hasExperience" class="mt-6">
            <h2 class="flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-gray-700">
                <span class="flex size-6 shrink-0 items-center justify-center rounded-full bg-orange-50 text-xs font-bold text-orange-600">2</span>
                Experience
            </h2>
            <div class="mt-2 space-y-3 pl-8">
                <div v-for="entry in resume.experience" :key="entry.id">
                    ...
                    <p v-if="entry.achievements" class="mt-1 whitespace-pre-line text-sm leading-relaxed text-gray-700">
                        <span class="font-medium text-orange-600">Achievements: </span>{{ entry.achievements }}
                    </p>
                </div>
            </div>
        </section>
        ...
        <section v-if="hasEducation" class="mt-6">
            <h2 class="flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-gray-700">
                <span class="flex size-6 shrink-0 items-center justify-center rounded-full bg-orange-50 text-xs font-bold text-orange-600">3</span>
                Education
            </h2>
        ...
        <section v-if="resume.skills.length" class="mt-6">
            <h2 class="flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-gray-700">
                <span class="flex size-6 shrink-0 items-center justify-center rounded-full bg-orange-50 text-xs font-bold text-orange-600">4</span>
                Skills
            </h2>
            <div class="mt-2 flex flex-wrap gap-2 pl-8">
                <span
                    ...
                    :key="skill"
                    class="flex items-center gap-1.5 rounded-full border border-orange-200 bg-orange-50/60 px-2.5 py-0.5 text-xs font-medium text-gray-700"
                >
        ...
        <section v-if="hasProjects" class="mt-6">
            <h2 class="flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-gray-700">
                <span class="flex size-6 shrink-0 items-center justify-center rounded-full bg-orange-50 text-xs font-bold text-orange-600">5</span>
                Projects
            </h2>
            <div class="mt-2 space-y-2 pl-8">
        ...
        <section v-if="hasCertifications" class="mt-6">
            <h2 class="flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-gray-700">
                <span class="flex size-6 shrink-0 items-center justify-center rounded-full bg-orange-50 text-xs font-bold text-orange-600">6</span>
                Certifications
            </h2>
        ...
        <section v-if="hasTrainings" class="mt-6">
            <h2 class="flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-gray-700">
                <span class="flex size-6 shrink-0 items-center justify-center rounded-full bg-orange-50 text-xs font-bold text-orange-600">7</span>
                Trainings & Seminars
            </h2>
            <div class="mt-2 space-y-2 pl-8">
        ...
        <section v-if="hasAwards" class="mt-6">
            <h2 class="flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-gray-700">
                <span class="flex size-6 shrink-0 items-center justify-center rounded-full bg-orange-50 text-xs font-bold text-orange-600">8</span>
                Awards & Achievements
            </h2>
            <div class="mt-2 space-y-2 pl-8">
        ...
        <section v-if="hasVolunteer" class="mt-6">
            <h2 class="flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-gray-700">
                <span class="flex size-6 shrink-0 items-center justify-center rounded-full bg-orange-50 text-xs font-bold text-orange-600">9</span>
        ...
        <section v-if="hasLanguages" class="mt-6">
            <h2 class="flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-gray-700">
                <span class="flex size-6 shrink-0 items-center justify-center rounded-full bg-orange-50 text-xs font-bold text-orange-600">10</span>
                Languages
            </h2>
            <p class="mt-2 pl-8 text-sm text-gray-700">
        ...
        <section v-for="section in visibleCustomSections" :key="section.id" class="mt-6">
            <h2 class="flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-gray-700">
                <span class="flex size-6 shrink-0 items-center justify-center rounded-full bg-orange-50 text-xs font-bold text-orange-600">+</span>
        ...
        <section v-if="hasReferences" class="mt-6">
            <h2 class="flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-gray-700">
                <span class="flex size-6 shrink-0 items-center justify-center rounded-full bg-orange-50 text-xs font-bold text-orange-600">R</span>
                References
            </h2>
            <div class="mt-2 space-y-1 pl-8">
