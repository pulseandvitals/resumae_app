...
<template>
    <div class="bg-white p-10 text-gray-900">
        ...
        <section v-if="resume.summary" class="mt-5 border-l-4 border-slate-300 pl-4">
            <span class="font-serif text-4xl leading-none text-slate-300">&ldquo;</span>
            <p class="-mt-3 text-sm leading-relaxed text-gray-700 italic">{{ resume.summary }}</p>
        </section>
