...
<template>
    <div class="bg-white p-10 text-gray-900">
        <header class="flex items-center gap-5 border-y-4 border-gray-900 py-4">
            <div v-if="resume.personal.photo" class="relative flex items-center gap-1">
                <div class="flex flex-col gap-1">
                    <span v-for="n in 3" :key="'l' + n" class="size-1.5 rounded-full bg-gray-900"></span>
                </div>
                <img :src="resume.personal.photo" alt="Profile photo" class="size-16 shrink-0 object-cover" />
                <div class="flex flex-col gap-1">
                    <span v-for="n in 3" :key="'r' + n" class="size-1.5 rounded-full bg-gray-900"></span>
                </div>
            </div>
            <div>
                <h1 class="text-2xl font-bold tracking-tight">{{ resume.personal.fullName || 'Your Name' }}</h1>
                <p v-if="resume.personal.title" class="mt-0.5 text-sm font-medium text-gray-600 italic">
        ...
        <section v-if="resume.summary" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900 border-b-2 border-gray-900 pb-1">Summary</h2>
            <p class="mt-1.5 text-sm leading-relaxed text-gray-700">{{ resume.summary }}</p>
        </section>

        <section v-if="hasExperience" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900 border-b-2 border-gray-900 pb-1">Experience</h2>
        ...
        <section v-if="hasEducation" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900 border-b-2 border-gray-900 pb-1">Education</h2>
        ...
        <section v-if="resume.skills.length" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900 border-b-2 border-gray-900 pb-1">Skills</h2>
        ...
        <section v-if="hasProjects" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900 border-b-2 border-gray-900 pb-1">Projects</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasCertifications" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900 border-b-2 border-gray-900 pb-1">Certifications</h2>
        ...
        <section v-if="hasTrainings" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900 border-b-2 border-gray-900 pb-1">Trainings & Seminars</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasAwards" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900 border-b-2 border-gray-900 pb-1">Awards & Achievements</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasVolunteer" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900 border-b-2 border-gray-900 pb-1">Volunteer Experience</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasLanguages" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900 border-b-2 border-gray-900 pb-1">Languages</h2>
        ...
        <section v-for="section in visibleCustomSections" :key="section.id" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900 border-b-2 border-gray-900 pb-1">{{ section.title || 'Additional Information' }}</h2>
            <div class="mt-2 space-y-2">
        ...
        <section v-if="hasReferences" class="mt-5">
            <h2 class="text-xs font-bold uppercase tracking-wide text-gray-900 border-b-2 border-gray-900 pb-1">References</h2>
            <div class="mt-2 space-y-1">
